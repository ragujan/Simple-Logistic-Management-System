...
public class OrderTest {
    ...
    public void testOrderCreation() {
        ...
        List<Destination> destinationList = em.createQuery("SELECT dt FROM Destination dt WHERE dt.id=:id", Destination.class).setParameter("id", 1).getResultList();
        ...
        List<Product> productList = em.createQuery("SELECT pdt FROM Product pdt WHERE pdt.id=:id", Product.class).setParameter("id", 1).getResultList();
